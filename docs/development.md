...
发版前跑 [手动回归清单](manual-regression.md)。

想做还没做的功能点记在 [`roadmap.md`](./roadmap.md)，落地过程记在
...
并给一条 warning——fork 出来走[打包自己的网站](../README.md#打包自己的网站)就是这种情况，
...
管，见 [`versioning.md`](./versioning.md)。
...
README 首页[用现成的 app](../README.md#预构建-app)那张表格链接到具体版本 tag，bump
版本后记得跟着更新。
